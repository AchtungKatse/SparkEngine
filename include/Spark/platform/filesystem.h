 ...
 */
SAPI b8 filesystem_open(const char* path, file_access_t mode, b8 binary, file_handle_t* out_handle);
 ...
 */
SAPI void filesystem_close(file_handle_t* handle);
 ...
 */
SAPI b8 filesystem_read_line(file_handle_t* handle, u64 max_length, char** line_buf, u64* out_line_length);
 ...
 * @returns True if successful; otherwise false.
 */
SAPI b8 filesystem_write_line(file_handle_t* handle, const char* text);
 ...
 * @returns True if successful; otherwise false.
 */
SAPI b8 filesystem_read(file_handle_t* handle, u64 data_size, void* out_data, u64* out_bytes_read);
 ...
 * @returns True if successful; otherwise false.
 */
SAPI b8 filesystem_read_all_bytes(file_handle_t* handle, u8* out_bytes, u64* out_bytes_read);
 ...
 * @returns True if successful; otherwise false.
 */
SAPI b8 filesystem_read_all_text(file_handle_t* handle, char* out_text, u64* out_bytes_read);
 ...
 * @returns True if successful; otherwise false.
 */
SAPI b8 filesystem_write(file_handle_t* handle, u64 data_size, const void* data, u64* out_bytes_written);
