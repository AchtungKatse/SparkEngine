...
// Mouse Input
SAPI b8 input_is_mouse_down(mouse_button_t key);
SAPI b8 input_is_mouse_up(mouse_button_t key);
SAPI b8 input_was_mouse_down(mouse_button_t key);
...
void input_process_mouse_wheel(s32 delta);
